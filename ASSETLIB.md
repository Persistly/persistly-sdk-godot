...
- Download/release: attach the `dist/persistly-godot-sdk-1.2.0.zip` generated by `scripts/package_release.sh`.
...
- [ ] `plugin.cfg` version is `1.2.0`.
- [ ] `addons/persistly/README.md` exists.
- [ ] `addons/persistly/LICENSE` exists.
- [ ] `scripts/package_release.sh 1.2.0` creates the release ZIP.
