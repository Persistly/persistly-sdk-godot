...
- `persistly_save_service.gd` wraps account attach/export plus named slot save and sync.
- `usage_example.gd` shows first-device export and second-device attach.
